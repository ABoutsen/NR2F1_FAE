...
feature_matrix_paths <- c(
  "~/Desktop/fc1_filtered_feature_bc_matrix/",
  "~/Desktop/fc2_filtered_feature_bc_matrix/",
  "~/Desktop/fc3_filtered_feature_bc_matrix/",
  "~/Desktop/fe1_filtered_feature_bc_matrix/",
  "~/Desktop/fe2_filtered_feature_bc_matrix/",
  "~/Desktop/fe3_filtered_feature_bc_matrix/"
)
...
s_genes <- unlist(read.table("F:/GIGA - PHD/Alcohol/106-0012_RNAseq/Seurat/Pipelines/Merge/s_genes.txt", header = TRUE), use.names = FALSE)
g2m_genes <- unlist(read.table("F:/GIGA - PHD/Alcohol/106-0012_RNAseq/Seurat/Pipelines/Merge/g2m_genes.txt", header = TRUE), use.names = FALSE)
